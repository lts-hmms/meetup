...
class Event extends Component {
    ...
    render(){
        ...
        return (<div className='event-overview bg-white text-center p-8 shadow-[10px_10px_5px_0px_rgba(192,132,252)] '>
            <h2 className='title mb-2 text-xl sm:text-2xl font-semibold'>{event.summary}</h2>
            <p className='date text-lg sm:text-xl'>{moment(event.start.dateTime).format('MMMM Do YYYY, h:mm a')}</p>
