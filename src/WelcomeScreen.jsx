...
function WelcomeScreen(props) {
    ...
    (
        <div className="WelcomeScreen fixed w-max top-0 min-h-screen text-center py-10 bg-orange-50">
            <div className="container mx-20 flex flex-col first-letter:gap-6 items-center">
                <img
