...
function WelcomeScreen(props) {
    ...
    (
        <div className="WelcomeScreen fixed w-max top-0 min-h-screen flex text-center flex-col py-10 gap-6 bg-orange-50">
            <div className="container mx-20 items-center">
            <img
